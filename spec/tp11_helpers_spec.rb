...
# share reusable code with Helpers
...
# remove create and walk dog code (it has been repeated and it would be best to remove repetition)
...
# shorter and cleaner :) , use helpers instead!
